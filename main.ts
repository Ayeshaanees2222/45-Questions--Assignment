...
// let famous_person:string=("William Shakespear")
// let message:string=("All that glitter is not gold.")
// console.log(`${famous_person} once said, "${message}"` );

// Q#6 tripping Names: Store a person’s name, and include some whitespace characters at the beginning and end of the name. Make sure you use each character combination, "\t" and "\n", at least once. Print the name once, so the whitespace around the name is displayed. Then print the name after striping the white spaces.
// let name1:string=("Ayesha\tAnees");
// let name2:string=("Ayesha\nAnees");
// console.log(name1)
// console.log(namme2)
...
//let names:string[]=["Fatima","Ayesha","Huda","Neha"]
// console.log(names[0]);
// console.log(names[1]);
// console.log(names[2]);
// console.log(names[3]);
...
// let message2: string = "is my university friend"
...
// let vehicles:string[] = ["Honda Civics", "Honda Motorcycle", "Honda City", "BMW"];
...
//let guestList:string[] = ["Fatima","Ayesha","Huda","Neha"]
// guestList.map((item)=> console.log(`Dear ${item} , you a invited to a dinner`));
...
// let newGuest: string = "Sumaira";
// guestList[guestList.indexOf(canNotAttend)] = newGuest;
// guestList.map((item) => console.log(`Dear ${item}, you are corodially invited to a dinner`));
...
// let beginningGuest: string = "Anum";
// guestList[guestList.unshift(beginningGuest)];
// let middleGuest: string = "Esha";
// let middleIndex = guestList.length / 2;
// guestList.splice(middleIndex, 0, middleGuest);
// let lastGuest: string = "Mehak";
...
// console.log(countriesArray.sort());     

// console.log(countriesArray);

// console.log(countriesArray.reverse()); 
...
// console.log(`${guestList.length} peoples are invited to the dinner`);
...
// let veg2: string = "Garlic";
// console.log(veg1 === veg2);
// console.log(veg1 !== veg2);

// let myName: string = "Ayesha Anees";
// let lowerCaseString: string = myName.toLowerCase();
// console.log(lowerCaseString === "Ayesha Anees");
// console.log(lowerCaseString !== "Ayesha Anees");
...
// let userName: string[] = ["Admin", "Neha", "Naeem"];
...
// let currentUsers: string[] = ["Ayesha", "Rehman", "Erum", "Huda", "Kashaf"];
// let newUsers: string[] = ["REHMAN", "NOOR", "KASHAF", "DUA", "HUDA"];
...
// let pizzas: string[] = ["Cheese", "Veggie", "Pepperoni"];
